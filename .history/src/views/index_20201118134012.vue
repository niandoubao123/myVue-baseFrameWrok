...
export default {
  ...
  watch: {
    ...
    levelSize(cul) {
      switch(+cul) {
        case 0:
        this.curProData = levelData.level10;
        break
        case 1:
        this.curProData = levelData.level12;
        break
        case 2:
        this.curProData = levelData.level15;
        break
        case 3:
        this.curProData = levelData.other15;
        break
        case 4:
