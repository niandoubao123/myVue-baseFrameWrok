            ...
            markers.push(
              new SimpleMarker({
                ...
                showPositionPoint: {
                  ...
                  radius: item['state'] == 5 || item['state'] == 4 ? 5 : 0
                },
                // 自定义定位点,波纹感的圆点
                iconLabel: `${(item['state'] !== 4 && item['state'] !== 5) ? '<div class="example"><span class="dot colorStyle'+ item.state +'"></span></div>' : ''}`,              
                //直接设置html(需要以"<"开头并且以">"结尾)
                map: map,
                ...
                label: {
                    ...
                    content: '<div class="makerLabel"><span class="mapIcon_title" style="color:' + color[item['state']] + '">' + item.city + '</span></div>'
                }
              }),
            )
          }
