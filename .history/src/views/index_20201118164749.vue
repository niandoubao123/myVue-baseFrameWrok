            ...
            markers.push(
              new SimpleMarker({
                ...
                label: {
                    ...
                    content: '<div class="makerLabel" style="width: 30px;height: 30px;border-radius: 50%;background: #ff6767;"><span class="mapIcon_title" style="color:red">' + item.city + '</span></div>'
                }
              }),
            )
          }
